...
- **WS2812 lights** — brake, turn indicators, halo, ignition-on animation (crank comet +
  ...
  never delivers a frame escalates to hazard after a short grace window).
...
```
pio test -e native        # 107 host unit tests (no hardware)
...
| `lights` | compositor: brake/indicators/ignition/DRS/rain/halo/hazard, gamma, power budget | yes |
